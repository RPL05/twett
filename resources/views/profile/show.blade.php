...
<section class="jumbotron text-center">
    <div class="pt-3 mb-2">
        <img src="{{asset('image/maxresdefault (2).jpg')}}" class="img-fluid" alt="" width="50%" height="10%">
    </div>
    </section>
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="mx-auto d-flex justify-content-center">
                                <img src="{{asset('image/epic-games-fortnite-tournament-mode-fix-update-scoring-changes.jpg')}}" class="rounded-circle" width="30%" height="180%" alt="">
                        ...
                        <div class="py-5">
                            <div class="d-flex justify-content-center">
                                <h3>
                                    <p class="font-weight-bolder">Fortnite</p>
                            ...
                            <div>
                                <h3>
                                    <span class="font-weight-bolder ">Gamers Pro and Writer</span>
                                </h3>
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="mb-3 d-flex">
                                        ...
                                        <h6 class="text-info pt-1">muhamad45454@gmail.com</h6>
                                    </div>
                                    <div class="mb-3 d-flex">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <h6 class="pt-1 text-info">110 Followers you know</h6>
                                    </div>
            ...
            <div class="col-md-8">
                ...
                <div class="card border-0 shadow pt-3 mb-3">
                    <div class="card-body">
                        <div class="d-flex">
                            <img src="{{asset('image/epic-games-fortnite-tournament-mode-fix-update-scoring-changes.jpg')}}"
                                width="13%"
                            ...
                            <div class="ml-3">
                                <div class="d-flex">
                                    ...
                                    <h6 class="pt-1 mr-2">02 hours ago.</h6>
