            ...
            <div class="card border-top-0" style="margin-top: -24px;">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        ...
                        <img src="{{asset('image/epic-games-fortnite-tournament-mode-fix-update-scoring-changes.jpg')}}" width="20" height="20" class="rounded-circle" alt="">
                        <div class="ml-3">
                            <div class="d-flex">
                                <div class="mr-auto">
                                    <small class="text-dark">Bayu
                    ...
                    <div class="d-flex">
                        <img src="{{asset('image/epic-games-fortnite-tournament-mode-fix-update-scoring-changes.jpg')}}" width="50" height="50" class="rounded-circle" alt="">
                            <div class="ml-3">
                                ...
                                <span class="text-muted">
                                <svg enable-background="new 0 0 100 100" id="Layer_1" version="1.1" class="ml-1" width="18" height="18" viewBox="0 0 100 100" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><polygon fill="#6c757d" points="78.2,35.3 65.7,22.8 64.2,24.3 74.3,34.3 20.9,34.2 20.9,49.1 23.2,49.1 23.2,36.4 74.3,36.4    64,46.6 65.5,48 78.2,35.4 78.2,35.3  "/><polygon fill="#6c757d" points="20.9,70.4 33.4,82.8 34.9,81.4 24.8,71.4 75.9,71.4 75.9,71.5 78.2,71.5 78.2,56.6 75.9,56.6    75.9,69.3 24.8,69.3 35.1,59.1 33.7,57.7 20.9,70.3 21,70.4  "/></g></svg>
                                <small>11</small>
                                </span>
                                <span class="text-muted">
                                    <svg fill="#6c757d" enable-background="new 0 0 128 128" height="13" id="Layer_1" version="1.1" viewBox="0 0 128 128" width="13" xml:space="preserve" class="ml-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><g><path d="M72.511,90.536c-0.386,1.035,0.14,2.187,1.175,2.573l16.745,6.248c-7.854,5.62-17.1,8.594-26.804,8.594    c-25.435,0-46.127-20.693-46.127-46.128c0-1.104-0.896-2-2-2s-2,0.896-2,2c0,27.64,22.487,50.128,50.127,50.128    c9.725,0,19.026-2.75,27.111-7.966l-3.087,14.551c-0.229,1.08,0.461,2.142,1.541,2.371c0.14,0.03,0.279,0.044,0.417,0.044    c0.925,0,1.755-0.645,1.954-1.586l4.69-22.105l-21.17-7.898C74.051,88.977,72.898,89.501,72.511,90.536z M64.375,16.322    c-9.728,0-19.03,2.749-27.11,7.963l3.086-14.548c0.229-1.081-0.46-2.142-1.541-2.371c-1.077-0.229-2.143,0.461-2.371,1.542    l-4.69,22.104l21.17,7.898c0.23,0.086,0.467,0.127,0.699,0.127c0.811,0,1.573-0.498,1.874-1.302    c0.386-1.034-0.14-2.187-1.175-2.573l-16.747-6.25c7.85-5.618,17.097-8.591,26.806-8.591c25.434,0,46.125,20.691,46.125,46.125    c0,1.104,0.896,2,2,2s2-0.896,2-2C114.5,38.808,92.014,16.322,64.375,16.322z" /></g></g></svg>
                                    <small>55</small>
                                </span>
                                <span class="text-muted">
                                <svg fill="#6c757d" nable-background="new 0 0 128 128" height="18" class="ml-1" version="1.1" viewBox="0 0 128 128" width="18" class="ml-1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Layer_2"/><g id="Layer_1"><path d="   M82.23,101.301c-1.994-1.107-19.021-10.56-19.021-10.56s-17.659,8.893-19.156,9.645c-1.497,0.751-5.058-0.425-4.447-3.552   c0.608-3.129,4.085-20.961,4.085-20.961S30.684,62.639,28.752,60.795s-1.22-5.113,2.137-5.523s20.913-2.557,20.913-2.557   s9.235-17.683,10.089-19.301c0.854-1.621,4.368-1.738,5.246,0.145c0.879,1.884,9.193,19.713,9.193,19.713s19.994,3.345,21.657,3.65   c2.582,0.479,2.779,3.662,1.227,5.106c-1.55,1.444-15.833,14.745-15.833,14.745s2.989,19.79,3.294,22.219   C86.979,101.421,84.226,102.408,82.23,101.301z" fill="none" stroke="#231F20" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="5"/></g></svg>
                                    <small>55</small>
                                </span>
                                <span class="text-muted ml-1">
                                <svg fill="none" height="12" stroke="#6c757d" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="2"/><circle cx="12" cy="4" r="2"/><circle cx="12" cy="20" r="2"/></svg>
                                </span>
                                </div>
                                </h6>
        ...
        <div class="col-md-3 rounded-bottom">
            <div class="card border-top-0" style="margin-top: -24px;">
                <div class="card-body">     
                    ...
                    <div class="pt-3">
                        <p class="font-weight bold">Who to follow</p>
                    </div>
